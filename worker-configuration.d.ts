/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bd4eb57f6fe38a892803b5a986ebcc29)
// Runtime types generated with workerd@1.20260212.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		ONEDRIVE_USER_EMAIL: string;
		ONEDRIVE_STORAGE_PATH: string;
		ONEDRIVE_CACHE_STORAGE_PATH: string;
		UPLOAD_TOKEN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ONEDRIVE_CLIENT_ID" | "ONEDRIVE_CLIENT_SECRET" | "ONEDRIVE_TENANT_ID" | "ONEDRIVE_USER_EMAIL" | "ONEDRIVE_STORAGE_PATH" | "ONEDRIVE_CACHE_STORAGE_PATH" | "UPLOAD_TOKEN">> {}
}
